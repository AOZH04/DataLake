(() => {
    ...
    function initSliders() {
        if (document.querySelector(".technologies__slider")) new core(".technologies__slider", {
    ...
    if (window.screen.width < 850) {
        let sliderClass = document.querySelector(".technologies__slider");
        if (sliderClass) sliderClass.classList.remove("technologies__slider");
    }
    let burgerIcon = document.querySelector(".menu__icon ");
    if (burgerIcon) burgerIcon.addEventListener("click", (function() {
